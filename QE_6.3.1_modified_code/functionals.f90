...
!  real(DP) :: k (3), mu(3)
  real(DP) :: k (4), mu(4)
  data k / 0.5757d0, 1.0000d0, 0.711357d0, 0.74d0 /, &
...
!           0.12345679012345679_DP,  0.22_dp, 0.1234_dp, 0.22_DP/, &
           0.12345679012345679_DP,  0.22_dp, 0.1234_dp, 0.0, 0.12345679012345679_dp/, &
  ...
  elseif ( iflag == 8) then
     ab=mu(iflag)/1.10_DP ! mu/ab=1.2
!     write(*,*) ab, iflag, mu(iflag)
!     ab=mu(iflag)*c7 ! mu/ab=1.2
     p=s1*c6
     c=log(p+sqrt(p*p+1)) ! asinh(p)
     dfx1=1+ab*s1*c
