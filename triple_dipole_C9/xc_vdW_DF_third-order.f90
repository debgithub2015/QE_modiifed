...
!DC added
  ...
  REAL(DP) :: y(Nqs_3ord), dP_dq0, P                       ! The y values for a given polynomial (all 0
                                                      ! exept for element i of P_i) The derivative
                                                      ! of P at a given q0 and the value of P at a
                                                      ! given q0. Both of these are interpolated
                                                      ! below.
  ...
  DO i_grid = 1, dfftp%nnr
     ...
     DO P_i = 1, Nqs_3ord
        ...
        IF (q0(i_grid) .NE. q_mesh(Nqs_3ord)) THEN
...
!  write(stdout,*) 'idx', idx, 'my_Nqs', my_Nqs
     ...
     DO r_i = 1, Nr_points
        d1  = q_mesh_3ord( indices3ord(idx+my_start_q-1, 1) ) * dr * r_i
        d2  = q_mesh_3ord( indices3ord(idx+my_start_q-1, 2) ) * dr * r_i
        d3  = q_mesh_3ord( indices3ord(idx+my_start_q-1, 3) ) * dr * r_i
...
!DC added
  ...
  ! The point at which to evaluate the kernel. d1 = q1*r, d2 = q2*r, d3 = q3*r
