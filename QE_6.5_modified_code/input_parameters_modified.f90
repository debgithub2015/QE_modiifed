...
!
        ...
        LOGICAL :: rhombohedral = .TRUE.
          ...
          !
! DC added 03/02/2020 
        CHARACTER(len=4) :: vdw_h_switch = 'DION'
          ! variable used to define the switching function for vdW-DF
          ! functional
        REAL :: gamma_hfunc = 1.0_DP 
        REAL :: beta_hfunc = 1.0_DP
        REAL :: alpha_hfunc = 1.0_DP
!        LOGICAL :: x_param = .FALSE.
          ! if .TRUE. changes the inside parameters of exchange and correlation
          ! for vdW-DF functional
!        LOGICAL :: optb88_param = .FALSE.
!        LOGICAL :: b86r_param = .FALSE.
        REAL :: mu_b88 = 1.0_DP
        REAL :: mu_b86r = 1.0_DP
        REAL :: kappa_b88 = 1.0_DP
        REAL :: c_b88 = 1.0_DP
        REAL :: beta_b86r = 1.0_DP
        REAL :: power_b86r = 1.0_DP 


! DC changed 03/02/2020
        NAMELIST / system / ibrav, celldm, a, b, c, cosab, cosac, cosbc, nat, &
             ...
             vdw_h_switch, gamma_hfunc, alpha_hfunc, beta_hfunc,              &   ! x_param, optb88_param, b86r_param, 
             mu_b88, mu_b86r, kappa_b88, c_b88, beta_b86r, power_b86r                                           
