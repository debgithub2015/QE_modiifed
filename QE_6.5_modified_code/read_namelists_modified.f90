...
!=======================================================================
     ...
     SUBROUTINE system_bcast()
       ...
       !
       ! vdW options broadcast
       ! DC added 03/02/2020
       CALL mp_bcast( vdw_h_switch,       ionode_id, intra_image_comm )
       CALL mp_bcast( gamma_hfunc,        ionode_id, intra_image_comm )
       CALL mp_bcast( alpha_hfunc,        ionode_id, intra_image_comm )
       CALL mp_bcast( beta_hfunc,         ionode_id, intra_image_comm )
!       CALL mp_bcast( x_param,            ionode_id, intra_image_comm )
!       CALL mp_bcast( optb88_param,       ionode_id, intra_image_comm )
!       CALL mp_bcast( b86r_param,         ionode_id, intra_image_comm )
       CALL mp_bcast( mu_b88,             ionode_id, intra_image_comm )
       CALL mp_bcast( mu_b86r,            ionode_id, intra_image_comm )
       CALL mp_bcast( kappa_b88,          ionode_id, intra_image_comm )
       CALL mp_bcast( c_b88,              ionode_id, intra_image_comm )
       CALL mp_bcast( beta_b86r,          ionode_id, intra_image_comm )
       CALL mp_bcast( power_b86r,         ionode_id, intra_image_comm )
